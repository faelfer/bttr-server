...
import br.com.bttr.time.dtos.TimeDtos.TimeResponse;
import br.com.bttr.time.dtos.TimeDtos.TimeView;
import br.com.bttr.time.dtos.TimeDtos.TimesResponse;
...
public class TimeResource {
  ...
  public PageResponse<TimeView> page(
  ...
  public TimesResponse byDate(
      @QueryParam("skill_id") @NotNull @Positive Long skillId,
  ...
  public TimeResponse one(@PathParam("id") @Positive Long id) {
    return new TimeResponse(service.one(id));
  }
  ...
  @PUT
  @Path("/update_time_by_id/{id}")
  @Operation(summary = "Atualizar registro de tempo")
  public MessageResponse update(
      @PathParam("id") @Positive Long id, @NotNull @Valid TimeInput input) {
    service.update(id, input);
    return new MessageResponse("tempo alterado com sucesso.");
  }

  @DELETE
  @Path("/delete_time_by_id/{id}")
