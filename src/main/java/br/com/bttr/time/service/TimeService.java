...
public class TimeService {
    ...
    public List<TimeView> byDate(Long skillId, String initial, String end) {
        ...
        try {
            ...
            if (from.isAfter(to)) throw new ApiException(400, "data inicial deve ser anterior ou igual à data final.");
            return repository.listBySkillAndPeriod(skillId, currentUser.get().id, from, to)
