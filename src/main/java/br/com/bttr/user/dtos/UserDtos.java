  ...
  public record SignUp(
      ...
      @NotBlank
          @Pattern(
              regexp = PASSWORD,
              message =
                  "senha deve conter número, símbolo, letra maiúscula e minúscula (4 a 128 caracteres)")
          String password) {}

  public record SignIn(@NotBlank @Email String email, @NotBlank @Size(max = 128) String password) {}
