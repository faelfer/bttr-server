...
class ApiContractTest {
  ...
  void setup() {
    ...
    when(identities.profile("alice"))
        .thenReturn(new IdentityProvider.Profile("alice", "Alice", "alice@example.com"));
  }
  ...
  private TimeEntity time(Long id, Instant created) {
    ...
    time.skill = skills.findById(id);
    time.minutes = 20;
    time.created = created;
    times.persistAndFlush(time);
    return time;
  }
  ...
  void listsOnlyOwnedSkillsAndPaginatesFiveItems() {
    ...
    given()
        ...
        .then()
        .statusCode(200)
        .body("skills", hasSize(7))
        .body("skills.name", not(hasItem("Privado")));
    given()
  ...
  void createsAndUpdatesSkillsWithNumericStringsFromClient() {
    given()
        ...
        .body(Map.of("name", " Quarkus ", "daily", "60"))
        .post("/skills/create_skill")
        .then()
        .statusCode(200)
        .body("message", is("habilidade foi criada com sucesso."));
    given().get("/skills/skills_from_user").then().body("skills.name", hasItem("Quarkus"));
    given()
        .contentType("application/json")
        .body(Map.of("name", "Kotlin", "daily", "45"))
        .put("/skills/update_skill_by_id/" + skillId)
        .then()
        .statusCode(200);
    given()
        .get("/skills/skill_by_id/" + skillId)
        .then()
        .statusCode(200)
        .body("skill.name", is("Kotlin"))
        .body("skill.daily", is(45));
    given()
        .contentType("application/json")
        .body(Map.of("name", " kotlin ", "daily", 10))
        .post("/skills/create_skill")
        .then()
        .statusCode(409);
  }
  ...
  void validatesPayloadsAndMalformedJson() {
    ...
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", skillId, "minutes", -1))
        .post("/times/create_time")
        .then()
        .statusCode(400);
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", skillId, "minutes", "abc"))
        .post("/times/create_time")
        .then()
        .statusCode(400)
        .body("message", not(emptyString()));
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", skillId, "minutes", 1.5))
        .post("/times/create_time")
        .then()
        .statusCode(400);
    given()
  ...
  void deniesReadingModifyingDeletingAndReferencingOtherUsersData() {
    ...
    given()
        .contentType("application/json")
        .body(Map.of("name", "Hack", "daily", 1))
        .put("/skills/update_skill_by_id/" + bobSkillId)
        .then()
        .statusCode(404);
    ...
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", skillId, "minutes", 1))
        .put("/times/update_time_by_id/" + bobTimeId)
        .then()
        .statusCode(404);
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", bobSkillId, "minutes", 1))
        .post("/times/create_time")
        .then()
        .statusCode(404);
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", bobSkillId, "minutes", 1))
        .put("/times/update_time_by_id/" + timeId)
        .then()
        .statusCode(404);
    given()
        .queryParam("skill_id", bobSkillId)
        .queryParam("date_initial", "2026-09-01T00:00:00Z")
        .queryParam("date_final", "2026-09-30T23:59:59Z")
  ...
  void timeCrudIncludesNestedSkillAndPreservesCreationDate() {
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", skillId.toString(), "minutes", "50"))
        .post("/times/create_time")
        .then()
        .statusCode(200);
    given()
        ...
        .statusCode(200)
        .body("count", is(2))
        .body("results.skill.name", everyItem(is("Java")))
        .body("results[0].minutes", is(50));
    given()
        .contentType("application/json")
        .body(Map.of("skill_id", skillId, "minutes", "40"))
        .put("/times/update_time_by_id/" + timeId)
        .then()
        .statusCode(200);
    given()
        .get("/times/time_by_id/" + timeId)
        .then()
        .statusCode(200)
        .body("time.minutes", is(40))
        .body("time.created", is("2026-09-01T03:00:00Z"))
        .body("time.skill.id", is(skillId.intValue()));
  ...
  void filtersInclusiveDatesAndRejectsInvalidIntervals() {
    ...
    given()
        ...
        .queryParam("date_initial", "2026-09-01T00:00:00-03:00")
        .queryParam("date_final", "2026-09-02T03:00:00Z")
        .get("/times/times_by_date")
        .then()
        .statusCode(200)
    ...
    given()
        .queryParam("skill_id", skillId)
        .queryParam("date_initial", "invalid")
        .queryParam("date_final", "2026-09-02T03:00:00Z")
        .get("/times/times_by_date")
        .then()
        .statusCode(400);
    given()
        .queryParam("skill_id", skillId)
        .queryParam("date_initial", "2026-10-01T00:00:00Z")
        .queryParam("date_final", "2026-09-01T00:00:00Z")
        .get("/times/times_by_date")
        .then()
        .statusCode(400);
  }
  ...
  void userLifecycleMatchesClientAndDelegatesCredentialsToKeycloak() {
    ...
    given()
        .contentType("application/json")
        .body(Map.of("username", "New", "email", "NEW@example.com", "password", "!Ab1!Ab1"))
        .post("/users/sign_up")
        .then()
        .statusCode(200);
    when(identities.authenticate("alice@example.com", "!Ab1!Ab1"))
        .thenReturn(
            new IdentityProvider.Login(
                "signed-token",
                new IdentityProvider.Profile("alice", "Alice", "alice@example.com")));
    given()
        .contentType("application/json")
        .body(Map.of("email", "alice@example.com", "password", "!Ab1!Ab1"))
        .post("/users/sign_in")
        .then()
        .statusCode(200)
        .body("token", is("signed-token"))
        .body("user.id", is(aliceId.intValue()))
        .body("user.password", nullValue());
    given().get("/users/profile").then().statusCode(200).body("user.username", is("Alice"));
    given()
        .contentType("application/json")
        .body(Map.of("username", "Alice2", "email", "NEW@example.com"))
        .patch("/users/profile")
        .then()
        .statusCode(200);
    ...
    given()
        .contentType("application/json")
        .body(Map.of("password", "!Ab1!Ab1", "new_password", "!Ab2!Ab2"))
  ...
  void rejectsWrongCurrentPasswordWithoutChangingIt() {
    when(identities.authenticate("alice@example.com", "wrong"))
        .thenThrow(new ApiException(401, "e-mail ou senha incorretos."));
    given()
        .contentType("application/json")
        .body(Map.of("password", "wrong", "new_password", "!Ab2!Ab2"))
        .post("/users/redefine_password")
        .then()
        .statusCode(401);
